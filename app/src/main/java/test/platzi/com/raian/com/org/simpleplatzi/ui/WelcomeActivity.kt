...
import test.platzi.com.raian.com.org.simpleplatzi.ui.fragments.InitialWelcomeFragment

class WelcomeActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {

    lateinit var presenter : IWelcomePresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager.beginTransaction()
                .replace(R.id.mFrameWelcomeContent, InitialWelcomeFragment(), InitialWelcomeFragment::class.java.simpleName)
                .commit()


        presenter = IWelcomePresenterImpl(this)
